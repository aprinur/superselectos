...
def get_product_url(category):
    ...
    product_url = response.html.find('.productos-page-inner')
    print(product_url)
...
def product_parser(html_page, ):
    ...
    price = html_page.find('div[class="info-middle mb-2"] div[class="right"]', first=True).text
